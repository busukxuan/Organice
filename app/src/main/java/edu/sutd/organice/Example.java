...
public final class Example {
    ...
    public static boolean gettingPhoneNumber = false;
    ...
    private static void onAuthorizationStateUpdated(TdApi.AuthorizationState authorizationState) {
        ...
        switch (Example.authorizationState.getConstructor()) {
            case TdApi.AuthorizationStateWaitTdlibParameters.CONSTRUCTOR:
                ...
                parameters.databaseDirectory = activity.getFilesDir().getAbsolutePath();
                parameters.useMessageDatabase = true;
                parameters.useSecretChats = true;
                parameters.apiId = 611772;
                parameters.apiHash = "6c33afaaf22568fb526bd770cfa31645";
                ...
                Log.d("Organice/TD", "set parameters");
                break;
            case TdApi.AuthorizationStateWaitEncryptionKey.CONSTRUCTOR:
                client.send(new TdApi.CheckDatabaseEncryptionKey(), new AuthorizationRequestHandler());
                Log.d("Organice/TD", "checked encryption key");
                break;
            case TdApi.AuthorizationStateWaitPhoneNumber.CONSTRUCTOR: {
                // send phone number
                Intent phoneNumberActivityIntent = new Intent(activity, PhoneNumberActivity.class);
                activity.startActivity(phoneNumberActivityIntent);
                break;
            }
            case TdApi.AuthorizationStateWaitCode.CONSTRUCTOR: {
                // send login code
                Intent loginCodeActivityIntent = new Intent(activity, LoginCodeActivity.class);
                activity.startActivity(loginCodeActivityIntent);
                break;
            }
            ...
            case TdApi.AuthorizationStateReady.CONSTRUCTOR:
                Log.d("Organice/TD", "authorization ready");
            ...
            case TdApi.AuthorizationStateClosed.CONSTRUCTOR:
                ...
                break;
            default:
                Toast.makeText(activity,"Unsupported authorization state:" + newLine + Example.authorizationState, Toast.LENGTH_LONG).show();;
        }
    }
        ...
        try {
            switch (commands[0]) {
                ...
                case "q":
                    ...
                    break;
                default:
                    Toast.makeText(activity, "Unsupported command: " + command, Toast.LENGTH_LONG);
            }
        } catch (ArrayIndexOutOfBoundsException e) {
            Toast.makeText(activity, "Not enough arguments", Toast.LENGTH_LONG);
        }
    }
                    ...
                    public void onResult(TdApi.Object object) {
                        switch (object.getConstructor()) {
                            case TdApi.Error.CONSTRUCTOR:
                                Toast.makeText(activity, "Receive an error for GetChats:" + newLine + object, Toast.LENGTH_LONG);
                                break;
                            case TdApi.Chats.CONSTRUCTOR:
                                ...
                                break;
                            default:
                                Toast.makeText(activity, "Receive wrong response from TDLib:" + newLine + object, Toast.LENGTH_LONG);
                        }
                    }
                });
                return;
    ...
    public static void main(String[] args, MainActivity activity) throws InterruptedException {
    ...
    private static class DefaultHandler implements Client.ResultHandler {
        @Override
        public void onResult(TdApi.Object object) {
//            activity.textView.setText(object.toString());
        }
    }
        ...
        public void onResult(TdApi.Object object) {
            switch (object.getConstructor()) {
                ...
                case TdApi.UpdateNewMessage.CONSTRUCTOR: {
                    ...
                    TdApi.MessageContent content = newMessage.message.content;
                    if (content instanceof TdApi.MessageText) {
                        TdApi.FormattedText text = ((TdApi.MessageText) content).text;
                        try {
                            activity.textView.setText(ActionRequest.parseMessage(text.text).toString());
                        } catch (ParseException e) {
                            throw new RuntimeException();
                        }
//                        activity.textView.setText(text.text);
                    }
                }
    ...
    private static class AuthorizationRequestHandler implements Client.ResultHandler {
        ...
        public void onResult(TdApi.Object object) {
            switch (object.getConstructor()) {
                case TdApi.Error.CONSTRUCTOR:
                    Toast.makeText(activity, "Receive an error:" + newLine + object, Toast.LENGTH_LONG);
    ...
    public static void sendPhoneNumber(String phoneNumber) {
        client.send(new TdApi.SetAuthenticationPhoneNumber(phoneNumber, false, false), new AuthorizationRequestHandler());
        Log.d("Organice/TD", "sent phone number");
    }

    public static void sendLoginCode(String code) {
        client.send(new TdApi.CheckAuthenticationCode(code, "", ""), new AuthorizationRequestHandler());
        Log.d("Organice/TD", "sent login code");
    }
}
